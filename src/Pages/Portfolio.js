    ...
    <section className={`flex flex-col w-full mx-auto`}>
      ...
      <div className={`mt-5 max-w-5xl mx-auto text-center`}>
        <p className="text-white text-lg">
          Below is a collection of games I've worked on over the years.
          These projects were developed in collaboration with teams, where I played a role in task delegation and feature development.
          Take your time to explore the projects and the work behind them.
        </p>
      </div>

      <div className={`top-[40px] ${styles.padding} max-w-7xl mx-auto`}>
        <h2 className="text-center text-3xl font-bold text-white my-10">Video Game Projects I've worked on</h2>
